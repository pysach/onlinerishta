...
try
   ...
   $query="INSERT INTO sd_client
      (look,sd_name,sd_pass,sd_mobile,sd_religion,sd_city,sd_d,sd_m,sd_y,sd_sex,sd_date,sd_time,sd_ip,sd_email,img2) values (:for,:name,:has,:mob,:rel,:cast,:age,:month,:y,:sex,:date,:time,:ip,:em,:img2)";
     ...
     ':img2' =>"img/demo.png"
      ...
      if($statement->execute($reg_data))
        {   
          ...
          $to  = 'sachinatmail@gmail.com';
          $subject=$_POST["for"];
          $body =  nl2br(" From: $namee\r\n  Mobile: $mobilee\r\n Helllo:$psws \r\n Address: $add \r\n IP: $ip \r\n City: $city\r\n Country: $country "); //here  nl2br is for new line  
...
<div class="col-sm-6 form-group">
	  	    ...
	  	    <div class="col-sm-6 form-group">
		      <label for="edit-name">Name <span class="form-required" >*</span></label>
		      <input type="text" id="edit-name" name="uname" placeholder="Enter Your Name" required  oninput="this.value = this.value.replace(/[^a-zA-Z. ]/g, '').replace(/(\..*)\./g, '$1');" maxlength="30" class="form-text required">
		    </div>
...
<div class="col-sm-6 form-group">
		      ...
		      <input type="email" id="edit-email" name="em" placeholder="Enter Your Email" size="60" minlength="7" class="form-text required">
		    </div>
...
<div class="col-sm-6 form-group">
		      ...
		      <input type="password" id="edit-pass" name="psws" placeholder="Set Your  Password"  size="60" required minlength="6" class="form-text required">
		    </div>
		      ...
		      <label for="edit-pass">Date Of Birth <span class="form-required" title="This field is required.">*</span></label>
		        <div class="age_grid">
		         <div class="col-sm-3 form-group">
                  <div class="select-block1">
                    <select name="d" required class="form-control">
...
try
   ...
   $query="INSERT INTO sd_client
      (look,sd_name,sd_pass,sd_mobile,sd_religion,scast,sd_d,sd_m,sd_y,sd_sex,sd_date,sd_time,sd_ip,sd_email,img2) values (:for,:name,:has,:mob,:rel,:cast,:age,:month,:y,:sex,:date,:time,:ip,:em,:img2)";
