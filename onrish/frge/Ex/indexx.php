 ...
 @media only screen and (max-width: 768px) {
    ...
    <div class="col-md-12">
        <div class="main-verification-input-wrap">
            ...
            <ul>
                <li>Please Enter Your Registered Email address below</li>
                <li>You will recieve a verification code on your registerd mail.</li>
            ...
            <input type="email" name="email" value="" required="" placeholder="Please Enter Your Registered Mail"> </div>
            <button class="main-verification-button" name="save">Verify Now</button>
            </form>
            </div>
        </div>
    </div>
